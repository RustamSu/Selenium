...
class ChromeAddresses(unittest.TestCase):
    ...
    def test_delete_address(self):
        ...
        print('click delete')
        driver.find_element(By.XPATH, '//div[@id="root"]/div/main/section/div/ul/li/div/div/div/span/div/button').click()
