...
from BrowserStack import des_cap
...
class FillFormUnitTestWinFireFox(unittest.TestCase):

    def setUp(self):
        url = h.command_exec
        self.driver = webdriver.Remote(command_executor=url,desired_capabilities=des_cap.desired_caps[1])
        # выбираем вариант оболочки из des_cap.py
    ...
    def test_fill_form(self):
        ...
        try:
            ...
            driver.find_element(By.XPATH,"//input[@placeholder='Country']").send_keys('Albania')
            sleep(1)
...
class FillFormUnitTestWinMacOSSafari(unittest.TestCase):

    def setUp(self):
        url = h.command_exec
        self.driver = webdriver.Remote(command_executor=url,desired_capabilities=des_cap.desired_caps[2])
        # выбираем вариант оболочки из des_cap.py
        #self.driver = webdriver.Firefox()
...
class FillFormUnitTestWinIPhone8(unittest.TestCase):

    def setUp(self):
        url = h.command_exec
        self.driver = webdriver.Remote(command_executor=url,desired_capabilities=des_cap.desired_caps[3])
        # выбираем вариант оболочки из des_cap.py
        #self.driver = webdriver.Firefox()
